...
# PREPARE DATA ----------------------------------------------------------
# -------------------------------------------------------------------------
load(file="02_transformed_data/observer/CPUE_catchability_adfg_sum.RData")
CPUE_catchability
...
# -------------------------------------------------------------------------
getwd()
outputs_file <- "04_outputs/user_grid_outEBS/no_sex/finescale/M0" 
...
# - Settings ----------------------------------------------------------------
getwd()
outputs_file <- "04_outputs/user_grid_outEBS/no_sex/finescale/M1" 
...
# -------------------------------------------------------------------------
getwd()
outputs_file <- "04_outputs/user_grid_outEBS/no_sex/finescale/M2" 
